"""	draw cumulative frequency response for epochs.
	3d Display.
"""
...
Z = np.zeros((475,101))
for x in range(470):
    model = torch.load('model/WaveMsNet_fixed_logmel_epoch'+str(x+1)+'.pkl', map_location='cpu')
...
ax1.plot_wireframe(X, Y, Z, rstride=47, cstride=0)
ax1.set_title("Cumulative Frequency Response of epochs on ESC-50")
