...
class WaveMsNet(nn.Module):
    def __init__(self):
        ...
        self.sincnet_1 = SincConv_fast(out_channels=80, kernel_size=81, sample_rate=16000, in_channels=1,
                                       stride=1, padding=40, dilation=1, bias=False, groups=1, min_low_hz=1,
