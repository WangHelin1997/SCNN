...
model = torch.load('model/WaveMsNet_fixed_logmel_epoch100.pkl', map_location='cpu')
...
# print(filt_b1[79].detach().numpy())
# print(filt_band[79].detach().numpy())
# dft_all = []
# dft_a , f1 = draw_frequency_response(a[79][0].detach().numpy(), draw_choice='true')
