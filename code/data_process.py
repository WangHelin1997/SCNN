...
# }}}
    def __init__(self, pkl_file, window_size=24000, train_slices=1, transform=None, phase=1):
        """
        :param pkl_file: 
        :param window_size: 
        :param num_slices: slices number of one record divide into.
    ...
    def __getitem__(self, index):
        ...
        if self.phase == 1:
            ...
            melspec = librosa.feature.melspectrogram(wave, 16000, n_fft=2048, hop_length=150, n_mels=96)  # (40, 442)
